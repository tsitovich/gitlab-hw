# Домашнее задание к занятию "`Система мониторинга Zabbix`" - `Tsitovich Vladimir`
...
![скриншот авторизации в админке](https://github.com/tsitovich/gitlab-hw/blob/zabbix1-branch/img/Screenshot_1.png)
...
![Название скриншота](https://github.com/tsitovich/gitlab-hw/blob/zabbix1-branch/img/Screenshot_7.png)
